      ...
      <nav className="sidebar">
        <ul className="list">
          ...
          <li onClick={()=>handleSelect(1)}>
            <Link href="dashboard" className={currentNav === 1 ? 'active' : ''}>Dashboard</Link>
          </li>
          <li  onClick={()=>handleSelect(2)}>
            <Link href="/portfolio" className={currentNav === 2 ? 'active' : ''}>Portfolio</Link>
          </li>
          <li onClick={()=>handleSelect(3)}>
            <Link href="/achievement" className={currentNav === 3 ? 'active' : ''}>Achievement</Link>
          </li>
